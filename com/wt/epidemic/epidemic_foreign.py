...
def get_data_resource_province(driver):
    ...
    driver.find_element_by_class_name("Common_1-1-" + number + "_3lDRV2").click()
    #Common_1-1-295_3lDRV2
    soup = BeautifulSoup(driver.page_source, "html.parser")
    pro_trs_data = soup.find_all("tr", attrs={"class": "VirusTable_1-1-"+number+"_2AH4U9"})
    print(pro_trs_data)
    # Tip_1-1-295_aNRVa5
    time_file = driver.find_element_by_class_name("Tip_1-1-"+number+"_aNRVa5")
    today_time = time_file
